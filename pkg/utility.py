...
class MlflowLogger:
    ...
    def __call__(self, # E_T_pred: Optional[np.ndarray], y_true: np.recarray,
        c_proba: Optional[List[np.ndarray]], true_c_vals: np.ndarray, custom_dict: Optional[Dict] = None) -> None:
